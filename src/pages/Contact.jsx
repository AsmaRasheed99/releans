          ...
          <div className="flex flex-wrap  lg:justify-around">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-base font-semibold text-[#75d5c7]">
                  Contact Us
                </span>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-[#75d5c7] bg-opacity-5 text-[#75d5c7] sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded border-[#75d5c7] bg-[#75d5c7] hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="border-[f0f0f0] w-full resize-none rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-[#75d5c7] focus-visible:shadow-none"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="border-[f0f0f0] w-full rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-[#75d5c7] focus-visible:shadow-none"
        />
      </div>
    </>
  );
